...
if __name__ == "__main__":
    ...
    validation_results = model.val(data="tools/updated_data.yaml", batch=1, device="0", iou=iou, split='test')  # Note iou is for NMS
    ...
    # Get Unknown Recall
    u_recall = compute_u_recall(model, "updated_data/test")